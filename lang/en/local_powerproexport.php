...
$string['coursecompletionscsvlocation'] = 'Course Completion CSV File Location';
$string['coursecompletionscsvlocationdesc'] = 'Full server path where Course Completion CSV files should be created. This directory must be writable by the web user';
$string['coursecompletionscsvprefix'] = 'Course Completion CSV File Name Prefix';
$string['coursecompletionscsvprefixdesc'] = 'The Course Completion CSV files will be created with a name of the current date in the format YYYYMMDD and an extension of ".csv". The prefix will be prepended to the beginning of the name';
